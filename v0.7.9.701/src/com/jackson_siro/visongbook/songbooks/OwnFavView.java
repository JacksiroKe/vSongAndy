...
public class OwnFavView extends AppFunctions {
	...
	ImageButton Favourite, GoOnline, EditSong;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		EditSong = (ImageButton) findViewById(R.id.btnedit);
		
		Favourite.setVisibility(View.GONE);
        GoOnline.setVisibility(View.GONE);
        EditSong.setVisibility(View.GONE);
	...
	public void setTextContent(Cursor cursor, Uri uri){
        ...
        setTitle(currentSong.getTitle());           
    	String[] Stanzas = TextUtils.split(currentSong.getContent(), "`");
        CustomSongView adapter = new CustomSongView(OwnFavView.this, Stanzas, FontSize);
        StanzasList.setAdapter(adapter);
    }
