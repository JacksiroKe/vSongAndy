...
public class OwnUpdateView extends AppFunctions {
	...
	ImageButton Favourite, CopySong, DeleteSong, UploadSong;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UploadSong = (ImageButton) findViewById(R.id.btnonline);
		
		Favourite.setVisibility(View.GONE);
		CopySong.setVisibility(View.GONE);
		DeleteSong.setVisibility(View.GONE);
    	UploadSong.setVisibility(View.GONE);
	...
	public void setTextContent(Cursor cursor, Uri uri){
        ...
        setTitle(currentSong.getTitle());           
    	String[] Stanzas = TextUtils.split(currentSong.getContent(), "`");
        CustomSongView adapter = new CustomSongView(OwnUpdateView.this, Stanzas, FontSize);
        StanzasList.setAdapter(adapter);
    }
