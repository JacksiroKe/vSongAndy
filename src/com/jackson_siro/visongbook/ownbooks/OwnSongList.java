...
public class OwnSongList extends ActionBarActivity {
	ListView list;
	...
	ArrayList<HashMap<String, String>> myOwnSongs;
	private static final String OWN_SONGID = "songid";
	private static final String OWN_TITLE = "title";
	private static final String OWN_CONTENT = "content";
	...
	private LinearLayout NothingHere;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mylist = db.getAllSongs();
		NothingText = (TextView)findViewById(R.id.text);

		FillListView();
		if (mylist.size() < 0){
			NothingText.setText(R.string.no_ownsong);
			
		} else {
			NothingText.setText(R.string.my_ownsong);				
		} 
	...
	private void FillListView(){
		...
		CustomSongList adapter = new CustomSongList(OwnSongList.this, My_Text, My_Texti, My_Textii);
		...
		list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
    			...
    			Intent intent = new Intent(OwnSongList.this, OwnSongView.class);
    			intent.putExtra("song", Integer.parseInt(My_Text[+ position]));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.own_list, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.newsong:
            	startActivity(new Intent(OwnSongList.this, OwnSongNew.class));
            	//startActivityForResult(new Intent(this, OwnSongNew.class), ACTIVITY_CREATE); 
                return true;                
            case R.id.information:
            	AlertDialog.Builder builder = new AlertDialog.Builder(OwnSongList.this);
