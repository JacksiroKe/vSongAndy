...
public class BaseUrlConfig {
    public static final String BaseUrl = "http://sing.appsmata.com/"; // change this url with your base url
    //public static final String BaseUrl = "http://192.168.43.16/vsongweb/"; // change this url with your base url
