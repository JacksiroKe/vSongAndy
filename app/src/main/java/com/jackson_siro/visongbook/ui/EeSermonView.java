...
public class EeSermonView extends AppCompatActivity {

    private static final String SERMON_ID = "key.EXTRA_OBJ_ID";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        cur_note = Integer.parseInt(getIntent().getStringExtra(SERMON_ID));
        ...
        singleView.setOnTouchListener(new SwipeTouchListener(EeSermonView.this){
        ...
        recyclerView.setOnTouchListener(new SwipeTouchListener(EeSermonView.this){
            public void onSwipeLeft() {
                Nextnote();
            }
            public void onSwipeRight() {
