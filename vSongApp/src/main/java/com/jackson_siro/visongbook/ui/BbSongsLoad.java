...
public class BbSongsLoad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coolText.setText("Task 1 of 2 in progress...\n\nGetting ready... The faster your device the better!");
    ...
    class AddtoDBTask extends AsyncTask<List<PostModel>, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            coolText.setText(String.format("Thanks for your patience, We're done setting up!"));
            finishLoading();
        }
        @Override
        protected void onPreExecute() {
            coolText.setText(String.format("Task 2 of 2 in progress... \n\nWe're glad you are patient enough to watch this"));
        }
        @Override
        protected void onProgressUpdate(Integer... values) {
            int cursong = (values[0] + 1);
            int progress = (cursong / songcount);
            downloadPercent.setText(progress + " %");
            downloadSize.setText(String.format("Song " + cursong + " of " + songcount));
    ...
    public void finishLoading(){
        ...
        prefedit.commit();
        startActivity(new Intent(BbSongsLoad.this, CcHomeView.class));
        finish();
    }
}
