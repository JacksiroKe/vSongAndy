...
public class DdHomeView extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void setupFloatingSearch() {
        mSearchView.setOnQueryChangeListener(new FloatingSearchView.OnQueryChangeListener() {
            ...
            public void onSearchTextChanged(String oldQuery, final String newQuery) {
                if (!oldQuery.equals("") && newQuery.equals("")) {
                    ...
                    SQLiteSearch.findSuggestions(DdHomeView.this, newQuery, 5, FIND_SUGGESTION_SIMULATED_DELAY,
        ...
        mSearchView.setOnSearchListener(new FloatingSearchView.OnSearchListener() {
            ...
            public void onSuggestionClicked(final SearchSuggestion searchSuggestion) {
                ...
                try {
                    ...
                    vSongBook.passingIntent(DdHomeView.this, searchModel.getID(), "EePostView");
                }
                catch (Exception e){ }
            ...
            public void onSearchAction(String query) {
                ...
                /*SQLiteSearch.findColors(DdHomeView.this, query,
        ...
        mSearchView.setOnFocusChangeListener(new FloatingSearchView.OnFocusChangeListener() {
            ...
            public void onFocus() {
                ...
                mSearchView.swapSuggestions(SQLiteSearch.getHistory(DdHomeView.this, 3));
        ...
        mSearchView.setOnMenuItemClickListener(new FloatingSearchView.OnMenuItemClickListener() {
            ...
            public void onActionMenuItemSelected(MenuItem item) {
                ...
                if (item.getItemId() == R.id.action_change_colors) {
                    ...
                    //just print action
                    Toast.makeText(DdHomeView.this.getApplicationContext(), item.getTitle(), Toast.LENGTH_SHORT).show();
                }
