...
public class CcHomeViewer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        if (prefget.getInt("user_userid", 0) != 0){
            ...
            user_view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    startActivity(new Intent(CcHomeViewer.this, UserProfile.class));
                }
            });
        }
    }
    ...
    private void signoutUser(){
        ...
        startActivity(new Intent(CcHomeViewer.this, AppStart.class));
        finish();
    }
