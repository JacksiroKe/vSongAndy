...
import com.jackson_siro.visongbook.data.DataHelper;

import java.util.List;


public class ScrollingSearchFragment extends BaseFragment implements AppBarLayout.OnOffsetChangedListener {
    ...
    private void setupSearchBar() {
        ...
        mSearchView.setOnSearchListener(new FloatingSearchView.OnSearchListener() {
            ...
            public void onSuggestionClicked(final SearchSuggestion searchSuggestion) {
                ...
                DataHelper.findColors(getActivity(), SearchModel.getBody(),
                        new DataHelper.OnFindSearchesListener() {
        ...
        mSearchView.setOnBindSuggestionCallback(new SearchSuggestionsAdapter.OnBindSuggestionCallback() {
            ...
            public void onBindSuggestion(View suggestionView, ImageView leftIcon,
                ...
                String text = SearchModel.getBody()
