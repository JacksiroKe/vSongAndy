...
public class SliderAdapter extends RecyclerView.Adapter implements SelectableViewHolder.OnItemSelectedListener {
    ...
    public SliderAdapter(SelectableViewHolder.OnItemSelectedListener listener,
    ...
    public SelectableViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.slider_item_single, parent, false);
        //View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.checkable_layout, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        holder.slug.setText(selectableItem.getBackpath());
        holder.number.setText(selectableItem.getTags());
        holder.songs.setText("#" + selectableItem.getQcount() + " songs");
