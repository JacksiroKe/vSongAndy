...
public class ListsReviewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ListsReviewsAdapter(Activity activity, List<PostModel> thisPost){
